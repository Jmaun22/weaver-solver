...
function ladderLength(beginWord, endWord, wordList) {
    ...
    while (len = queue.length) {
      for (i = 0; i < len; i++) {
        word = queue.shift();
        if (word === endWord) return mywords;
  ...
  function pushNextWord(word, queue, wordSet) {
...
// function randomWord(fourLetterWords) {
        
//         var randomNumber = Math.floor(Math.random() * fourLetterWords.length);
//         return fourLetterWords[randomNumber];
// }


// var random = randomWord(fourLetterWords);
// console.log(random)

// //while loop for matching opperation
// var match = false; 
...
// }
// else {
//     console.log(random + 'firstList')
//     wordList.push(random);
...
//     var random = randomWord(uniqueWords);
//     // console.log(random)
//     var threeInARow = 0;

//     if (random[0] == target[0]) {
//         threeInARow++;

//     }
//    else if(random[1] == target[1]) {
//         threeInARow++;

//     }
//   else if(random[2] == target[2]) {
//         threeInARow++;


//     }
// else if(random[3] == target[3]) {
//         threeInARow++;
//         console.log(threeInARow)
...
// console.log(wordListOne)

// // IF there are no matches you 
...
//     var unique_randomWord = randomWord(uniqueWords);
  
//    console.log(unique_randomWord)
//     var threeInARow = 0;
//     // console.log(typeof(target[0]) + typeof(unique_randomWord[0]) + typeof(random[0]))

//     if (random[0] ==  unique_randomWord[0] && target[0] == random[0]) {
//         threeInARow++;
      

//     }
//    if(random[1] ==  unique_randomWord[1]  && target[1] == random[1]) {
//         threeInARow++;

//     }
// if(random[2] ==  unique_randomWord[2]  && target[2] == random[2]) {
//         threeInARow++;


//     }
// if(random[3] ==  unique_randomWord[3] && target[3] == random[3]) {
//         threeInARow++;
//         console.log(threeInARow)
...
//     console.log(random + 'firstList')
//     wordListOne.push(random);
//     wordListOne.push(unique_randomWord);
//     threeInARow = 0;
